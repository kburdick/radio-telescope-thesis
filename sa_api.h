/*
* Signal Hound SDK Header file
* created by: SignalHound
* modified by: Kurt Burdick
* date modified: 9-3-19
*/

#ifndef SIGNALHOUND_TEST_SA_API_H
#define SIGNALHOUND_TEST_SA_API_H
...
extern "C" {
	...
	SA_API saStatus saGetRealTimeFrame(int device, float *sweep, float *colorFrame, float *alphaFrame);
...
#endif //SIGNALHOUND_TEST_SA_API_H
